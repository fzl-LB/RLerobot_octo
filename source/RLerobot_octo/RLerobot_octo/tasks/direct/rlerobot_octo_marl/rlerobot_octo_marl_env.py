...
from .rlerobot_octo_marl_env_cfg import RlerobotOctoMarlEnvCfg


class RlerobotOctoMarlEnv(DirectMARLEnv):
    cfg: RlerobotOctoMarlEnvCfg

    def __init__(self, cfg: RlerobotOctoMarlEnvCfg, render_mode: str | None = None, **kwargs):
